...
x_train = img.flow_from_directory('/scratch/ideeps/mateus.miranda/ai4luc/cerradata80k_splited/train',
                                  target_size=(256, 256),
                                  batch_size=64,
                                  color_mode='rgb',
...
x_valida = img.flow_from_directory('/scratch/ideeps/mateus.miranda/ai4luc/cerradata80k_splited/val',
                                   target_size=(256, 256),
                                   batch_size=64,
                                   color_mode='rgb',
                                   class_mode="categorical",
