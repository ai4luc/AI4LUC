...
def train_model(model, criterion, dataloaders, optimizer, metrics, save_path, num_epochs, name_dataset):
    ...
    with open(os.path.join(save_path, name_dataset + '_run1_unet.csv'), 'w') as csvfile:
    ...
    model.eval()
    with open(os.path.join(save_path, name_dataset + '_run1_unet.csv'), 'a') as csvfile:
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    ...
    torch.save(model.state_dict(),
               os.path.join(str(save_path), str(name_dataset) + '_run1_unet.pt'))
